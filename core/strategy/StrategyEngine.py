...
def to_strategy_snapshot(structure: StructureSnapshot) -> StrategySnapshot:
    ...
    return StrategySnapshot(
        ...
        # Fix #7AD — straight copy, no recomputation, no new fetch.
        po3_stage=getattr(structure, "po3_stage", "none"),
        po3_hypothesis_direction=getattr(structure, "po3_hypothesis_direction", None),
        po3_direction=getattr(structure, "po3_direction", None),
        po3_range_start_index=getattr(structure, "po3_range_start_index", None),
        po3_range_start_timestamp=getattr(structure, "po3_range_start_timestamp", None),
        po3_range_end_index=getattr(structure, "po3_range_end_index", None),
        po3_range_end_timestamp=getattr(structure, "po3_range_end_timestamp", None),
        po3_range_high=getattr(structure, "po3_range_high", None),
        po3_range_low=getattr(structure, "po3_range_low", None),
        po3_manipulation_index=getattr(structure, "po3_manipulation_index", None),
        po3_manipulation_timestamp=getattr(structure, "po3_manipulation_timestamp", None),
        po3_manipulation_open=getattr(structure, "po3_manipulation_open", None),
        po3_manipulation_high=getattr(structure, "po3_manipulation_high", None),
        po3_manipulation_low=getattr(structure, "po3_manipulation_low", None),
        po3_manipulation_close=getattr(structure, "po3_manipulation_close", None),
        po3_reclaim_index=getattr(structure, "po3_reclaim_index", None),
        po3_reclaim_timestamp=getattr(structure, "po3_reclaim_timestamp", None),
        po3_reclaim_open=getattr(structure, "po3_reclaim_open", None),
        po3_reclaim_high=getattr(structure, "po3_reclaim_high", None),
        po3_reclaim_low=getattr(structure, "po3_reclaim_low", None),
        po3_reclaim_close=getattr(structure, "po3_reclaim_close", None),
        po3_distribution_index=getattr(structure, "po3_distribution_index", None),
        po3_distribution_timestamp=getattr(structure, "po3_distribution_timestamp", None),
        po3_distribution_open=getattr(structure, "po3_distribution_open", None),
        po3_distribution_high=getattr(structure, "po3_distribution_high", None),
        po3_distribution_low=getattr(structure, "po3_distribution_low", None),
        po3_distribution_close=getattr(structure, "po3_distribution_close", None),
    )
